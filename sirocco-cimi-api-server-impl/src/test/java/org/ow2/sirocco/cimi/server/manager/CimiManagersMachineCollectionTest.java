...
@AdditionalClasses({ManagerProducers.class, CimiManagerActionMachine.class, CimiManagerReadMachine.class,
    ...
    CimiManagerReadMachineCollection.class, CallServiceHelperImpl.class, MergeReferenceHelperImpl.class})
public class CimiManagersMachineCollectionTest {
    ...
    public void testRead() throws Exception {
        ...
        QueryResult<Machine> queryResult = new QueryResult<Machine>(list.size(), list);

        EasyMock.expect(this.service.getMachines()).andReturn(queryResult);
