...
/**
 * Manage READ request of AddressTemplates collection.
 */
@org.ow2.sirocco.cimi.server.manager.Manager("CimiManagerReadAddressTemplateCollection")
public class CimiManagerReadAddressTemplateCollection extends CimiManagerReadAbstract {
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        ...
        if (false == context.hasParamsForReadingCollection()) {
            out = this.manager.getAddressTemplates();
        } else {
            QueryResult<?> results = this.manager.getAddressTemplates(context.valueOfFirst(), context.valueOfLast(),
    ...
    protected void convertToResponse(final CimiContext context, final Object dataService) throws Exception {
        CimiAddressTemplateCollectionRoot cimi = (CimiAddressTemplateCollectionRoot) context.convertToCimi(dataService,
            CimiAddressTemplateCollectionRoot.class);
