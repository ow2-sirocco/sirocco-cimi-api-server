...
/**
 * Collection of AddressTemplate.
 */
@XmlRootElement
@XmlType(propOrder = {"id", "count", "array", "operations"})
@JsonSerialize(include = Inclusion.NON_NULL)
public class CimiAddressTemplateCollection extends CimiCollectionAbstract<CimiAddressTemplate> {
     ...
     */
    @Override
    @XmlElement(name = "AddressTemplate")
    @JsonProperty(value = "addresses")
    public CimiAddressTemplate[] getArray() {
    ...
    @Override
    @JsonProperty(value = "addresses")
    public void setArray(final CimiAddressTemplate[] items) {
     ...
     */
    @Override
    public CimiArray<CimiAddressTemplate> newCollection() {
        return new CimiAddressTemplateArray();
    }
    ...
    public ExchangeType getExchangeType() {
        return ExchangeType.AddressTemplateCollection;
    }
    ...
    @XmlTransient
    @JsonIgnore
    public Class<CimiAddressTemplate> getItemClass() {
        return CimiAddressTemplate.class;
    }

    /**
     * Concrete class of the collection.
     */
    public class CimiAddressTemplateArray extends CimiArrayAbstract<CimiAddressTemplate> {

        /** Serial number */
        private static final long serialVersionUID = 1L;

        @Override
        public CimiAddressTemplate[] newEmptyArraySized() {
            return new CimiAddressTemplate[this.size()];
        }
    }
}
