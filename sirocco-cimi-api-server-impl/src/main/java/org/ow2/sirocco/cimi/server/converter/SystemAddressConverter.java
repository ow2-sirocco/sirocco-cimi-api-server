 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiSystemAddress}</li>
 * <li>Service model: {@link SystemAddress}</li>
 * </ul>
 * </p>
 */
// FIXME SystemAddress missing !
public class SystemAddressConverter extends ObjectCommonConverter {
    /**
     * {@inheritDoc}
     * 
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiSystemAddress cimi = new CimiSystemAddress();
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        // FIXME SystemAddress missing !
        // this.doCopyToCimi(context, (SystemAddress) dataService,
        // (CimiSystemAddress) dataCimi);
    }
    ...
    public Object toService(final CimiContext context, final Object dataCimi) {
        // FIXME SystemAddress missing !
        return null;
        // SystemAddress service = new SystemAddress();
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        // FIXME SystemAddress missing !
        // this.doCopyToService(context, (CimiSystemAddress) dataCimi,
        // (SystemAddress) dataService);
    }
    ...
    // SystemAddress dataService, final CimiSystemAddress dataCimi) {
    // this.fill(context, dataService, dataCimi);
    // if (true == context.mustBeExpanded(dataCimi)) {
    // dataCimi.setAddress((CimiAddress)
    // context.convertNextCimi(dataService.getResource(), CimiAddress.class));
    // }
    // }
    ...
    // CimiSystemAddress dataCimi, final SystemAddress dataService) {
    // this.fill(context, dataCimi, dataService);
    // dataService.setResource((CloudResource)
    // context.convertNextService(dataCimi.getAddress()));
    // }
}
