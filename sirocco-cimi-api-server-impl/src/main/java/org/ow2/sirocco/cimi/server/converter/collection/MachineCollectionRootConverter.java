 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiMachineCollectionRoot}</li>
 * <li>Service model: {@link List<Machine>}</li>
 * </ul>
 * </p>
 */
public class MachineCollectionRootConverter extends MachineCollectionConverter {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiMachineCollectionRoot cimi = new CimiMachineCollectionRoot();
