 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiSystemAddressCollectionRoot}</li>
 * <li>Service model: {@link List<SystemAddress>}</li>
 * </ul>
 * </p>
 */
public class SystemAddressCollectionRootConverter extends SystemAddressCollectionConverter {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiSystemAddressCollectionRoot cimi = new CimiSystemAddressCollectionRoot();
