 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiEventLogTemplateCollection}</li>
 * <li>Service model: {@link List<EventLogTemplate>}</li>
 * </ul>
 * </p>
 */
public class EventLogTemplateCollectionConverter extends CollectionConverterAbstract {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiEventLogTemplateCollection cimi = new CimiEventLogTemplateCollection();
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (List<Object>) dataService, (CimiEventLogTemplateCollection) dataCimi);
    }
    ...
    public Object toService(final CimiContext context, final Object dataCimi) {
        List<EventLogTemplate> service = new ArrayList<EventLogTemplate>();
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiEventLogTemplateCollection) dataCimi, (List<Object>) dataService);
    }
