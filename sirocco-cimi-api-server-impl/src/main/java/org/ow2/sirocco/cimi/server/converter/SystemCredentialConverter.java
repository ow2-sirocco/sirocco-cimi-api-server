 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiSystemCredential}</li>
 * <li>Service model: {@link SystemCredential}</li>
 * </ul>
 * </p>
 */
public class SystemCredentialConverter extends ObjectCommonConverter {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiSystemCredential cimi = new CimiSystemCredential();
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (SystemCredentials) dataService, (CimiSystemCredential) dataCimi);
    }
    ...
    public Object toService(final CimiContext context, final Object dataCimi) {
        SystemCredentials service = new SystemCredentials();
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiSystemCredential) dataCimi, (SystemCredentials) dataService);
    }
     ...
     */
    protected void doCopyToCimi(final CimiContext context, final SystemCredentials dataService,
        final CimiSystemCredential dataCimi) {
        this.fill(context, dataService, dataCimi);
        if (true == context.mustBeExpanded(dataCimi)) {
            dataCimi.setCredential((CimiCredential) context.convertNextCimi(dataService.getResource(), CimiCredential.class));
        }
    }
