...
/**
 * Manage DELETE request of NetworkPort.
 */
@org.ow2.sirocco.cimi.server.manager.Manager("CimiManagerDeleteNetworkPort")
public class CimiManagerDeleteNetworkPort extends CimiManagerDeleteAbstract {
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        return this.manager.deleteNetworkPort(context.getRequest().getId());
    }
