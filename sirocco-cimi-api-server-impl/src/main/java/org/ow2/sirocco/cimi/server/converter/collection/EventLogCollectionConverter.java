 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiEventLogCollection}</li>
 * <li>Service model: {@link List<EventLog>}</li>
 * </ul>
 * </p>
 */
public class EventLogCollectionConverter extends CollectionConverterAbstract {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiEventLogCollection cimi = new CimiEventLogCollection();
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (List<Object>) dataService, (CimiEventLogCollection) dataCimi);
    }
    ...
    public Object toService(final CimiContext context, final Object dataCimi) {
        List<EventLog> service = new ArrayList<EventLog>();
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiEventLogCollection) dataCimi, (List<Object>) dataService);
    }
