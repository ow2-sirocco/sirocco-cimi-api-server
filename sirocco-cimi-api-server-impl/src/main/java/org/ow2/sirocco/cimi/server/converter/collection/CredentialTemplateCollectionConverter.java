 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiCredentialTemplateTemplateCollection}</li>
 * <li>Service model: {@link List<CredentialsTemplate>}</li>
 * </ul>
 * </p>
 */
public class CredentialTemplateCollectionConverter extends CollectionConverterAbstract {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiCredentialTemplateCollection cimi = new CimiCredentialTemplateCollection();
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (List<Object>) dataService, (CimiCredentialTemplateCollection) dataCimi);
    }
    ...
    public Object toService(final CimiContext context, final Object dataCimi) {
        List<CredentialsTemplate> service = new ArrayList<CredentialsTemplate>();
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiCredentialTemplateCollection) dataCimi, (List<Object>) dataService);
    }
