 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiMachineTemplateCollectionRoot}</li>
 * <li>Service model: {@link List<MachineTemplate>}</li>
 * </ul>
 * </p>
 */
public class MachineTemplateCollectionRootConverter extends MachineTemplateCollectionConverter {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiMachineTemplateCollectionRoot cimi = new CimiMachineTemplateCollectionRoot();
