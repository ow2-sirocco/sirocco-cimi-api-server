 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiAddressTemplateCollectionRoot}</li>
 * <li>Service model: {@link List<AddressTemplate>}</li>
 * </ul>
 * </p>
 */
public class AddressTemplateCollectionRootConverter extends AddressTemplateCollectionConverter {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiAddressTemplateCollectionRoot cimi = new CimiAddressTemplateCollectionRoot();
