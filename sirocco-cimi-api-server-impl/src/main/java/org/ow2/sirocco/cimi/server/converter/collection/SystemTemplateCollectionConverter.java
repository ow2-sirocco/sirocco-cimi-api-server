 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiSystemTemplateCollection}</li>
 * <li>Service model: {@link List<SystemTemplate>}</li>
 * </ul>
 * </p>
 */
public class SystemTemplateCollectionConverter extends CollectionConverterAbstract {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiSystemTemplateCollection cimi = new CimiSystemTemplateCollection();
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (List<Object>) dataService, (CimiSystemTemplateCollection) dataCimi);
    }
    ...
    public Object toService(final CimiContext context, final Object dataCimi) {
        List<SystemTemplate> service = new ArrayList<SystemTemplate>();
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiSystemTemplateCollection) dataCimi, (List<Object>) dataService);
    }
