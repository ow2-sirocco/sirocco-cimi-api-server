 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiMachineNetworkInterfaceCollection}</li>
 * <li>Service model: {@link List<MachineNetworkInterface>}</li>
 * </ul>
 * </p>
 */
public class MachineNetworkInterfaceCollectionConverter extends CollectionConverterAbstract {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiMachineNetworkInterfaceCollection cimi = new CimiMachineNetworkInterfaceCollection();
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (List<Object>) dataService, (CimiMachineNetworkInterfaceCollection) dataCimi);
    }
    ...
    public Object toService(final CimiContext context, final Object dataCimi) {
        List<MachineNetworkInterface> service = new ArrayList<MachineNetworkInterface>();
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiMachineNetworkInterfaceCollection) dataCimi, (List<Object>) dataService);
    }
