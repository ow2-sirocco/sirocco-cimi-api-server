 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiMachineTemplateVolumeTemplate}</li>
 * <li>Service model: {@link MachineVolu1meTemplate}</li>
 * </ul>
 * </p>
 */
public class MachineTemplateVolumeTemplateConverter extends VolumeTemplateConverter {
    /**
     * {@inheritDoc}
     * 
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiMachineTemplateVolumeTemplate cimi = new CimiMachineTemplateVolumeTemplate();
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (MachineVolumeTemplate) dataService, (CimiMachineTemplateVolumeTemplate) dataCimi);
    }
    ...
    public Object toService(final CimiContext context, final Object dataCimi) {
        MachineVolumeTemplate service = new MachineVolumeTemplate();
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiMachineTemplateVolumeTemplate) dataCimi, (MachineVolumeTemplate) dataService);
    }
     ...
     */
    protected void doCopyToService(final CimiContext context, final CimiMachineTemplateVolumeTemplate dataCimi,
        final MachineVolumeTemplate dataService) {
        dataService.setInitialLocation(dataCimi.getInitialLocation());
        dataService.setVolumeTemplate((VolumeTemplate) context.convertNextService(dataCimi, CimiVolumeTemplate.class));
    }
}
