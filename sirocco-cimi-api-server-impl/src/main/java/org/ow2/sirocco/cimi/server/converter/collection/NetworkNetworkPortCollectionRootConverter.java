 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiNetworkNetworkPortCollectionRoot}</li>
 * <li>Service model: {@link List<NetworkNetworkPort>}</li>
 * </ul>
 * </p>
 */
public class NetworkNetworkPortCollectionRootConverter extends NetworkNetworkPortCollectionConverter {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiNetworkNetworkPortCollectionRoot cimi = new CimiNetworkNetworkPortCollectionRoot();
