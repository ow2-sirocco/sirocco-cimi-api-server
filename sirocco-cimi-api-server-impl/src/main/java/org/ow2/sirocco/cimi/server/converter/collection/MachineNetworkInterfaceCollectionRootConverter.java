 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiMachineNetworkInterfaceCollectionRoot}</li>
 * <li>Service model: {@link List<MachineNetworkInterface>}</li>
 * </ul>
 * </p>
 */
public class MachineNetworkInterfaceCollectionRootConverter extends MachineNetworkInterfaceCollectionConverter {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiMachineNetworkInterfaceCollectionRoot cimi = new CimiMachineNetworkInterfaceCollectionRoot();
