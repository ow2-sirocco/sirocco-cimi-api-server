...
/**
 * Manage CREATE request of NetworkPortTemplate.
 */
@org.ow2.sirocco.cimi.server.manager.Manager("CimiManagerCreateNetworkPortTemplate")
public class CimiManagerCreateNetworkPortTemplate extends CimiManagerCreateAbstract {
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        return this.manager.createNetworkPortTemplate((NetworkPortTemplate) dataService);
    }
    ...
    protected void beforeConvertToDataService(final CimiContext context) throws Exception {
        this.mergeReference.merge(context, (CimiNetworkPortTemplate) context.getRequest().getCimiData());
    }
}
