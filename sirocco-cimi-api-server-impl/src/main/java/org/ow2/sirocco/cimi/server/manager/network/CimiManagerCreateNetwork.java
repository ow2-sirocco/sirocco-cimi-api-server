...
/**
 * Manage CREATE request of Network.
 */
@org.ow2.sirocco.cimi.server.manager.Manager("CimiManagerCreateNetwork")
public class CimiManagerCreateNetwork extends CimiManagerCreateAbstract {
    @Inject
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        return this.manager.createNetwork((NetworkCreate) dataService);
    }
    ...
    protected void beforeConvertToDataService(final CimiContext context) throws Exception {
        this.mergeReference.merge(context, (CimiNetworkCreate) context.getRequest().getCimiData());
    }
