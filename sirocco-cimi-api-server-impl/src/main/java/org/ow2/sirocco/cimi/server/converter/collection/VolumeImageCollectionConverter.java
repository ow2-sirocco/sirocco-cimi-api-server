 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiVolumeImageCollection}</li>
 * <li>Service model: {@link List<VolumeImage>}</li>
 * </ul>
 * </p>
 */
public class VolumeImageCollectionConverter extends CollectionConverterAbstract {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiVolumeImageCollection cimi = new CimiVolumeImageCollection();
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (List<Object>) dataService, (CimiVolumeImageCollection) dataCimi);
    }
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiVolumeImageCollection) dataCimi, (List<Object>) dataService);
    }
