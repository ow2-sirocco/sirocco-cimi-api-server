...
public class CimiManagerReadEventLogTemplateCollection extends CimiManagerReadAbstract {
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        ...
        if (false == context.hasParamsForReadingCollection()) {
            out = this.manager.getEventLogTemplates();
        } else {
            QueryResult<?> results = this.manager.getEventLogTemplates(context.valueOfFirst(), context.valueOfLast(),
    ...
    protected void convertToResponse(final CimiContext context, final Object dataService) throws Exception {
        CimiEventLogTemplateCollectionRoot cimi = (CimiEventLogTemplateCollectionRoot) context.convertToCimi(dataService,
            CimiEventLogTemplateCollectionRoot.class);
