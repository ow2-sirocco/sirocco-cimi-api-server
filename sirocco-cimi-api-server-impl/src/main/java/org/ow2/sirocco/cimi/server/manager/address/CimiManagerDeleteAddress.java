...
/**
 * Manage DELETE request of Address.
 */
@org.ow2.sirocco.cimi.server.manager.Manager("CimiManagerDeleteAddress")
public class CimiManagerDeleteAddress extends CimiManagerDeleteAbstract {
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        return this.manager.deleteAddress(context.getRequest().getId());
    }
