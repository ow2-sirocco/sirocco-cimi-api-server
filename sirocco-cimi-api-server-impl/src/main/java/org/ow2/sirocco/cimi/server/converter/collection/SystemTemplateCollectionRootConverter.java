 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiSystemTemplateCollectionRoot}</li>
 * <li>Service model: {@link List<SystemTemplate>}</li>
 * </ul>
 * </p>
 */
public class SystemTemplateCollectionRootConverter extends SystemTemplateCollectionConverter {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiSystemTemplateCollectionRoot cimi = new CimiSystemTemplateCollectionRoot();
