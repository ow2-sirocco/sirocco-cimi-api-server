 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiSystemNetworkPortCollection}</li>
...
public class SystemNetworkPortCollectionConverter extends CollectionConverterAbstract {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiSystemNetworkPortCollection cimi = new CimiSystemNetworkPortCollection();
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (List<Object>) dataService, (CimiSystemNetworkPortCollection) dataCimi);
    }
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiSystemNetworkPortCollection) dataCimi, (List<Object>) dataService);
    }
