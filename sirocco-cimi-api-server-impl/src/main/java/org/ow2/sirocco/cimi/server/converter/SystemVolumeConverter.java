 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiSystemVolume}</li>
 * <li>Service model: {@link SystemVolume}</li>
 * </ul>
 * </p>
 */
public class SystemVolumeConverter extends ObjectCommonConverter {
    /**
     * {@inheritDoc}
     * 
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiSystemVolume cimi = new CimiSystemVolume();
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (SystemVolume) dataService, (CimiSystemVolume) dataCimi);
    }
    ...
    public Object toService(final CimiContext context, final Object dataCimi) {
        SystemVolume service = new SystemVolume();
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiSystemVolume) dataCimi, (SystemVolume) dataService);
    }
