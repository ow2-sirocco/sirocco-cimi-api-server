...
/**
 * Manage CREATE request of Network Configuration.
 */
@org.ow2.sirocco.cimi.server.manager.Manager("CimiManagerCreateNetworkConfiguration")
public class CimiManagerCreateNetworkConfiguration extends CimiManagerCreateAbstract {
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        return this.manager.createNetworkConfiguration((NetworkConfiguration) dataService);
    }
    ...
    protected void beforeConvertToDataService(final CimiContext context) throws Exception {
        this.mergeReference.merge(context, (CimiNetworkConfiguration) context.getRequest().getCimiData());
    }
}
