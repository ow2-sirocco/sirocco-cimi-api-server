...
/**
 * Manage READ request of EventLogs collection.
 */
@org.ow2.sirocco.cimi.server.manager.Manager("CimiManagerReadEventLogCollection")
public class CimiManagerReadEventLogCollection extends CimiManagerReadAbstract {
    ...
    protected void convertToResponse(final CimiContext context, final Object dataService) throws Exception {
        CimiEventLogCollectionRoot cimi = (CimiEventLogCollectionRoot) context.convertToCimi(dataService,
            CimiEventLogCollectionRoot.class);
