...
/**
 * Manage DELETE request of VolumeTemplate.
 */
@org.ow2.sirocco.cimi.server.manager.Manager("CimiManagerDeleteVolumeTemplate")
public class CimiManagerDeleteVolumeTemplate extends CimiManagerDeleteAbstract {
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        this.manager.deleteVolumeTemplate(context.getRequest().getId());
        return null;
    }
