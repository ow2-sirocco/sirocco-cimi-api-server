 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiEvent}</li>
 * <li>Service model: {@link Event}</li>
 * </ul>
 * </p>
 */
public class EventConverter extends ObjectCommonConverter {
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (Event) dataService, (CimiEvent) dataCimi);
    }
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiEvent) dataCimi, (Event) dataService);
    }
