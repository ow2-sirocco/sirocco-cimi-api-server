 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiMachineVolumeCollectionRoot}</li>
 * <li>Service model: {@link List<MachineVolume>}</li>
 * </ul>
 * </p>
 */
public class MachineVolumeCollectionRootConverter extends MachineVolumeCollectionConverter {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiMachineVolumeCollectionRoot cimi = new CimiMachineVolumeCollectionRoot();
