 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiSystemCreate}</li>
 * <li>Service model: {@link SystemCreate}</li>
 * </ul>
 * </p>
 */
public class SystemCreateConverter implements CimiConverter {
    ...
    public Object toService(final CimiContext context, final Object dataCimi) {
        SystemCreate service = new SystemCreate();
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiSystemCreate) dataCimi, (SystemCreate) dataService);
    }
     ...
     */
    protected void fill(final CimiSystemCreate dataCimi, final SystemCreate dataService) {
     ...
     * @param dataService Destination Service object
     */
    protected void doCopyToService(final CimiContext context, final CimiSystemCreate dataCimi, final SystemCreate dataService) {
        this.fill(dataCimi, dataService);
        dataService.setSystemTemplate((SystemTemplate) context.convertNextService(dataCimi.getSystemTemplate()));
