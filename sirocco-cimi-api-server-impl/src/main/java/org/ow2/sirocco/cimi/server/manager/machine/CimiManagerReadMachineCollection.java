...
/**
 * Manage READ request of Machines collection.
 */
@org.ow2.sirocco.cimi.server.manager.Manager("CimiManagerReadMachineCollection")
public class CimiManagerReadMachineCollection extends CimiManagerReadAbstract {
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        ...
        if (false == context.hasParamsForReadingCollection()) {
            out = this.manager.getMachines().getItems();
        } else {
    ...
    protected void convertToResponse(final CimiContext context, final Object dataService) throws Exception {
        CimiMachineCollectionRoot cimi = (CimiMachineCollectionRoot) context.convertToCimi(dataService,
            CimiMachineCollectionRoot.class);
