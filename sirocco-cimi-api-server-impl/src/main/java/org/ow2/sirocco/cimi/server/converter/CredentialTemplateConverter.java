 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiCredentialTemplate}</li>
...
public class CredentialTemplateConverter extends ObjectCommonConverter {
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (CredentialsTemplate) dataService, (CimiCredentialTemplate) dataCimi);
    }
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiCredentialTemplate) dataCimi, (CredentialsTemplate) dataService);
    }
    ...
    protected void doCopyToCimi(final CimiContext context, final CredentialsTemplate dataService,
        final CimiCredentialTemplate dataCimi) {
     ...
     */
    protected void doCopyToService(final CimiContext context, final CimiCredentialTemplate dataCimi,
