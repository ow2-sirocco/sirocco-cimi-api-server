...
/**
 * Manage READ request of ForwardingGroups collection.
 */
@org.ow2.sirocco.cimi.server.manager.Manager("CimiManagerReadForwardingGroupCollection")
public class CimiManagerReadForwardingGroupCollection extends CimiManagerReadAbstract {
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        ...
        if (false == context.hasParamsForReadingCollection()) {
            out = this.manager.getForwardingGroups().getItems();
        } else {
            QueryResult<?> results = this.manager.getForwardingGroups(context.valueOfFirst(), context.valueOfLast(),
    ...
    protected void convertToResponse(final CimiContext context, final Object dataService) throws Exception {
        CimiForwardingGroupCollectionRoot cimi = (CimiForwardingGroupCollectionRoot) context.convertToCimi(dataService,
