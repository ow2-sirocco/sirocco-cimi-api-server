 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiSystemForwardingGroupCollectionRoot}</li>
 * <li>Service model: {@link List<SystemForwardingGroup>}</li>
 * </ul>
 * </p>
 */
public class SystemForwardingGroupCollectionRootConverter extends SystemForwardingGroupCollectionConverter {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiSystemForwardingGroupCollectionRoot cimi = new CimiSystemForwardingGroupCollectionRoot();
