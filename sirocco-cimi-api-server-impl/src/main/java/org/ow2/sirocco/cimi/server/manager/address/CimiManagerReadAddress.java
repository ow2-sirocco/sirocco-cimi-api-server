...
/**
 * Manage READ request of Address.
 */
@org.ow2.sirocco.cimi.server.manager.Manager("CimiManagerReadAddress")
public class CimiManagerReadAddress extends CimiManagerReadAbstract {
    ...
    protected void convertToResponse(final CimiContext context, final Object dataService) throws Exception {
        CimiAddress cimi = (CimiAddress) context.convertToCimi(dataService, CimiAddress.class);
