...
/**
 * Manage DELETE request of CredentialTemplate.
 */
@org.ow2.sirocco.cimi.server.manager.Manager("CimiManagerDeleteCredentialTemplate")
public class CimiManagerDeleteCredentialTemplate extends CimiManagerDeleteAbstract {
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        this.manager.deleteCredentialsTemplate(context.getRequest().getId());
        return null;
    }
