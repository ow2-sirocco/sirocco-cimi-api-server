...
/**
 * Collection of SystemNetwork.
 */
@XmlRootElement
@XmlType(propOrder = {"id", "count", "array", "operations"})
@JsonSerialize(include = Inclusion.NON_NULL)
public class CimiSystemNetworkCollection extends CimiCollectionAbstract<CimiSystemNetwork> {
     ...
     */
    @Override
    @XmlElement(name = "SystemNetwork")
    @JsonProperty(value = "systemNetworks")
    public CimiSystemNetwork[] getArray() {
    ...
    @Override
    @JsonProperty(value = "systemNetworks")
    public void setArray(final CimiSystemNetwork[] items) {
     ...
     */
    @Override
    public CimiArray<CimiSystemNetwork> newCollection() {
        return new CimiSystemNetworkArray();
    }
    ...
    public ExchangeType getExchangeType() {
        return ExchangeType.SystemNetworkCollection;
    }
    ...
    @XmlTransient
    @JsonIgnore
    public Class<CimiSystemNetwork> getItemClass() {
        return CimiSystemNetwork.class;
    }

    /**
     * Concrete class of the collection.
     */
    public class CimiSystemNetworkArray extends CimiArrayAbstract<CimiSystemNetwork> {

        /** Serial number */
        private static final long serialVersionUID = 1L;

        @Override
        public CimiSystemNetwork[] newEmptyArraySized() {
            return new CimiSystemNetwork[this.size()];
        }
    }
}
