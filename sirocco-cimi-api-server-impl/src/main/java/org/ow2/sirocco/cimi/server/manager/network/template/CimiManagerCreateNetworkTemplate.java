...
public class CimiManagerCreateNetworkTemplate extends CimiManagerCreateAbstract {
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        return this.manager.createNetworkTemplate((NetworkTemplate) dataService);
    }
    ...
    protected void beforeConvertToDataService(final CimiContext context) throws Exception {
        this.mergeReference.merge(context, (CimiNetworkTemplate) context.getRequest().getCimiData());
    }
}
