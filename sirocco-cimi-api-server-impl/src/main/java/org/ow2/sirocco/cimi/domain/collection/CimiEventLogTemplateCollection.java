...
/**
 * Collection of EventLogTemplate.
 */
@XmlRootElement
@XmlType(propOrder = {"id", "count", "array", "operations"})
@JsonSerialize(include = Inclusion.NON_NULL)
public class CimiEventLogTemplateCollection extends CimiCollectionAbstract<CimiEventLogTemplate> {
     ...
     */
    @Override
    @XmlElement(name = "EventLogTemplate")
    @JsonProperty(value = "eventLogTemplates")
    public CimiEventLogTemplate[] getArray() {
    ...
    @Override
    @JsonProperty(value = "eventLogTemplates")
    public void setArray(final CimiEventLogTemplate[] items) {
     ...
     */
    @Override
    public CimiArray<CimiEventLogTemplate> newCollection() {
        return new CimiEventLogTemplateArray();
    }
    ...
    public ExchangeType getExchangeType() {
        return ExchangeType.EventLogTemplateCollection;
    }
    ...
    @XmlTransient
    @JsonIgnore
    public Class<CimiEventLogTemplate> getItemClass() {
        return CimiEventLogTemplate.class;
    }

    /**
     * Concrete class of the collection.
     */
    public class CimiEventLogTemplateArray extends CimiArrayAbstract<CimiEventLogTemplate> {

        /** Serial number */
        private static final long serialVersionUID = 1L;

        @Override
        public CimiEventLogTemplate[] newEmptyArraySized() {
            return new CimiEventLogTemplate[this.size()];
        }
    }
}
