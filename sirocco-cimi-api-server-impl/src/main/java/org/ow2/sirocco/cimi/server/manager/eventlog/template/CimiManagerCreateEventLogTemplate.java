...
public class CimiManagerCreateEventLogTemplate extends CimiManagerCreateAbstract {
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        return this.manager.createEventLogTemplate((EventLogTemplate) dataService);
    }
    ...
    protected void beforeConvertToDataService(final CimiContext context) throws Exception {
        this.mergeReference.merge(context, (CimiEventLogTemplate) context.getRequest().getCimiData());
    }
}
