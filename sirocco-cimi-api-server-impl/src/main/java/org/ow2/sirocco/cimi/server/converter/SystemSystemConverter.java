 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiSystemSystem}</li>
 * <li>Service model: {@link SystemSystem}</li>
 * </ul>
 * </p>
 */
public class SystemSystemConverter extends ObjectCommonConverter {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiSystemSystem cimi = new CimiSystemSystem();
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (SystemSystem) dataService, (CimiSystemSystem) dataCimi);
    }
    ...
    public Object toService(final CimiContext context, final Object dataCimi) {
        SystemSystem service = new SystemSystem();
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiSystemSystem) dataCimi, (SystemSystem) dataService);
    }
