 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiEventTypeState}</li>
 * <li>Service model: {@link StateEventType}</li>
 * </ul>
 * </p>
 */
public class EventTypeStateConverter extends EventTypeConverter {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiEventTypeState cimi = new CimiEventTypeState();
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (StateEventType) dataService, (CimiEventTypeState) dataCimi);
    }
     ...
     */
    protected void doCopyToCimi(final CimiContext context, final StateEventType dataService, final CimiEventTypeState dataCimi) {
        this.fill(context, dataService, dataCimi);
        dataCimi.setPrevious(dataService.getPreviousState());
        dataCimi.setState(dataService.getState());
    }
}
