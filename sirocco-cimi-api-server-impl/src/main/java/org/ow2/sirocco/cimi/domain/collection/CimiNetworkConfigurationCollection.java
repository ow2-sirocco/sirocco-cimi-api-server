...
/**
 * Collection of NetworkConfiguration.
 */
@XmlRootElement
@XmlType(propOrder = {"id", "count", "array", "operations"})
@JsonSerialize(include = Inclusion.NON_NULL)
public class CimiNetworkConfigurationCollection extends CimiCollectionAbstract<CimiNetworkConfiguration> {
    ...
    public CimiNetworkConfiguration[] getArray() {
    ...
    @Override
    @JsonProperty(value = "networkConfigurations")
    public void setArray(final CimiNetworkConfiguration[] items) {
     ...
     */
    @Override
    public CimiArray<CimiNetworkConfiguration> newCollection() {
        return new CimiNetworkConfigurationArray();
    }
    ...
    @XmlTransient
    @JsonIgnore
    public Class<CimiNetworkConfiguration> getItemClass() {
        return CimiNetworkConfiguration.class;
    }

    /**
     * Concrete class of the collection.
     */
    public class CimiNetworkConfigurationArray extends CimiArrayAbstract<CimiNetworkConfiguration> {

        /** Serial number */
        private static final long serialVersionUID = 1L;

        @Override
        public CimiNetworkConfiguration[] newEmptyArraySized() {
            return new CimiNetworkConfiguration[this.size()];
        }
    }
}
