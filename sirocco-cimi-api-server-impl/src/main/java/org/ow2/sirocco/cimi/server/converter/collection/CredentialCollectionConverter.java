 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiCredentialCollection}</li>
 * <li>Service model: {@link List<Credentials>}</li>
 * </ul>
 * </p>
 */
public class CredentialCollectionConverter extends CollectionConverterAbstract {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiCredentialCollection cimi = new CimiCredentialCollection();
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (List<Object>) dataService, (CimiCredentialCollection) dataCimi);
    }
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiCredentialCollection) dataCimi, (List<Object>) dataService);
    }
