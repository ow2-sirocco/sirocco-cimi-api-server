 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiForwardingGroupCollection}</li>
 * <li>Service model: {@link List<ForwardingGroup>}</li>
 * </ul>
 * </p>
 */
public class ForwardingGroupCollectionConverter extends CollectionConverterAbstract {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiForwardingGroupCollection cimi = new CimiForwardingGroupCollection();
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (List<Object>) dataService, (CimiForwardingGroupCollection) dataCimi);
    }
    ...
    public Object toService(final CimiContext context, final Object dataCimi) {
        List<ForwardingGroup> service = new ArrayList<ForwardingGroup>();
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiForwardingGroupCollection) dataCimi, (List<Object>) dataService);
    }
