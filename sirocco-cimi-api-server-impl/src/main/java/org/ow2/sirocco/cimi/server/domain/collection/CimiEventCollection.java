...
public class CimiEventCollection extends CimiCollectionAbstract<CimiEvent> {
    ...
    @Override
    @JsonProperty(value = "events")
    public void setArray(final CimiEvent[] items) {
     ...
     */
    @Override
    public CimiArray<CimiEvent> newCollection() {
        return new CimiEventArray();
    }
    ...
    public ExchangeType getExchangeType() {
        return ExchangeType.EventCollection;
    }
    ...
    @XmlTransient
    @JsonIgnore
    public Class<CimiEvent> getItemClass() {
        return CimiEvent.class;
    }

    /**
     * Concrete class of the collection.
     */
    public class CimiEventArray extends CimiArrayAbstract<CimiEvent> {

        /** Serial number */
        private static final long serialVersionUID = 1L;

        @Override
        public CimiEvent[] newEmptyArraySized() {
            return new CimiEvent[this.size()];
        }
    }
}
