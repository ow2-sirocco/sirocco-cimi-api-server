 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiNetworkTemplateCollection}</li>
 * <li>Service model: {@link List<NetworkTemplate>}</li>
 * </ul>
 * </p>
 */
public class NetworkTemplateCollectionConverter extends CollectionConverterAbstract {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiNetworkTemplateCollection cimi = new CimiNetworkTemplateCollection();
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (List<Object>) dataService, (CimiNetworkTemplateCollection) dataCimi);
    }
    ...
    public Object toService(final CimiContext context, final Object dataCimi) {
        List<NetworkTemplate> service = new ArrayList<NetworkTemplate>();
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiNetworkTemplateCollection) dataCimi, (List<Object>) dataService);
    }
