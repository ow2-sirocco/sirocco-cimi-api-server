 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiSystemVolumeCollectionRoot}</li>
 * <li>Service model: {@link List<SystemVolume>}</li>
 * </ul>
 * </p>
 */
public class SystemVolumeCollectionRootConverter extends SystemVolumeCollectionConverter {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiSystemVolumeCollectionRoot cimi = new CimiSystemVolumeCollectionRoot();
