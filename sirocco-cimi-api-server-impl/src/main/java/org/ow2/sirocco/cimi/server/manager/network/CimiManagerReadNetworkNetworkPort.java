...
/**
 * Manage READ request of NetworkPort of a Network.
 */
@org.ow2.sirocco.cimi.server.manager.Manager("CimiManagerReadNetworkNetworkPort")
public class CimiManagerReadNetworkNetworkPort extends CimiManagerReadAbstract {
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        NetworkNetworkPort out = null;
        out = this.manager.getNetworkPortFromNetwork(context.getRequest().getIdParent(), context.getRequest().getId());
        return out;
    }
    ...
    protected void convertToResponse(final CimiContext context, final Object dataService) throws Exception {
        CimiNetworkNetworkPort cimi = (CimiNetworkNetworkPort) context.convertToCimi(dataService, CimiNetworkNetworkPort.class);
