...
/**
 * Collection of SystemSystem.
 */
@XmlRootElement
@XmlType(propOrder = {"id", "count", "array", "operations"})
@JsonSerialize(include = Inclusion.NON_NULL)
public class CimiSystemSystemCollection extends CimiCollectionAbstract<CimiSystemSystem> {
     ...
     */
    @Override
    @XmlElement(name = "SystemSystem")
    @JsonProperty(value = "systemSystems")
    public CimiSystemSystem[] getArray() {
    ...
    @Override
    @JsonProperty(value = "systemSystems")
    public void setArray(final CimiSystemSystem[] items) {
     ...
     */
    @Override
    public CimiArray<CimiSystemSystem> newCollection() {
        return new CimiSystemSystemArray();
    }
    ...
    public ExchangeType getExchangeType() {
        return ExchangeType.SystemSystemCollection;
    }
    ...
    @XmlTransient
    @JsonIgnore
    public Class<CimiSystemSystem> getItemClass() {
        return CimiSystemSystem.class;
    }

    /**
     * Concrete class of the collection.
     */
    public class CimiSystemSystemArray extends CimiArrayAbstract<CimiSystemSystem> {

        /** Serial number */
        private static final long serialVersionUID = 1L;

        @Override
        public CimiSystemSystem[] newEmptyArraySized() {
            return new CimiSystemSystem[this.size()];
        }
    }
}
