 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiSystemForwardingGroupCollection}</li>
 * <li>Service model: {@link List<SystemForwardingGroup>}</li>
 * </ul>
 * </p>
 */
public class SystemForwardingGroupCollectionConverter extends CollectionConverterAbstract {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiSystemForwardingGroupCollection cimi = new CimiSystemForwardingGroupCollection();
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (List<Object>) dataService, (CimiSystemForwardingGroupCollection) dataCimi);
    }
    ...
    public Object toService(final CimiContext context, final Object dataCimi) {
        List<SystemForwardingGroup> service = new ArrayList<SystemForwardingGroup>();
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiSystemForwardingGroupCollection) dataCimi, (List<Object>) dataService);
    }
