...
/**
 * Manage READ request of Systems collection.
 */
@org.ow2.sirocco.cimi.server.manager.Manager("CimiManagerReadSystemCollection")
public class CimiManagerReadSystemCollection extends CimiManagerReadAbstract {
    ...
    protected void convertToResponse(final CimiContext context, final Object dataService) throws Exception {
        CimiSystemCollectionRoot cimi = (CimiSystemCollectionRoot) context.convertToCimi(dataService,
            CimiSystemCollectionRoot.class);
