...
/**
 * Manage CREATE request of NetworkNetworkPort.
 */
@org.ow2.sirocco.cimi.server.manager.Manager("CimiManagerCreateNetworkNetworkPort")
public class CimiManagerCreateNetworkNetworkPort extends CimiManagerCreateAbstract {
    @Inject
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        return this.manager.addNetworkPortToNetwork(context.getRequest().getIdParent(), (NetworkNetworkPort) dataService);
    }
    ...
    protected void beforeConvertToDataService(final CimiContext context) throws Exception {
        this.mergeReference.merge(context, (CimiNetworkNetworkPort) context.getRequest().getCimiData());
    }
