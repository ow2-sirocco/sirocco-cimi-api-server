 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiEventTypeAlarm}</li>
 * <li>Service model: {@link AlarmEventType}</li>
 * </ul>
 * </p>
 */
public class EventTypeAlarmConverter extends EventTypeConverter {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiEventTypeAlarm cimi = new CimiEventTypeAlarm();
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (AlarmEventType) dataService, (CimiEventTypeAlarm) dataCimi);
    }
     ...
     */
    protected void doCopyToCimi(final CimiContext context, final AlarmEventType dataService, final CimiEventTypeAlarm dataCimi) {
        this.fill(context, dataService, dataCimi);
        dataCimi.setCode(dataService.getCode());
    }
}
