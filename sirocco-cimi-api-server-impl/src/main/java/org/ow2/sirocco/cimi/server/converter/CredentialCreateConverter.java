 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiCredentialCreate}</li>
...
public class CredentialCreateConverter implements CimiConverter {
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiCredentialCreate) dataCimi, (CredentialsCreate) dataService);
    }
     ...
     */
    protected void fill(final CimiCredentialCreate dataCimi, final CredentialsCreate dataService) {
     ...
     * @param dataService Destination Service object
     */
    protected void doCopyToService(final CimiContext context, final CimiCredentialCreate dataCimi,
