 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiSystemVolumeCollection}</li>
 * <li>Service model: {@link List<SystemVolume>}</li>
 * </ul>
 * </p>
 */
public class SystemVolumeCollectionConverter extends CollectionConverterAbstract {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiSystemVolumeCollection cimi = new CimiSystemVolumeCollection();
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (List<Object>) dataService, (CimiSystemVolumeCollection) dataCimi);
    }
    ...
    public Object toService(final CimiContext context, final Object dataCimi) {
        List<SystemVolume> service = new ArrayList<SystemVolume>();
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiSystemVolumeCollection) dataCimi, (List<Object>) dataService);
    }
