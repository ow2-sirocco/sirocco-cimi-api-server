...
/**
 * Manage DELETE request of EventLogTemplate.
 */
@org.ow2.sirocco.cimi.server.manager.Manager("CimiManagerDeleteEventLogTemplate")
public class CimiManagerDeleteEventLogTemplate extends CimiManagerDeleteAbstract {
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        this.manager.deleteEventLogTemplate(context.getRequest().getId());
        return null;
    }
