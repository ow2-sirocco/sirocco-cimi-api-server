 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiVolumeCollection}</li>
 * <li>Service model: {@link List<Volume>}</li>
 * </ul>
 * </p>
 */
public class VolumeCollectionConverter extends CollectionConverterAbstract {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiVolumeCollection cimi = new CimiVolumeCollection();
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (List<Object>) dataService, (CimiVolumeCollection) dataCimi);
    }
    ...
    public Object toService(final CimiContext context, final Object dataCimi) {
        List<Volume> service = new ArrayList<Volume>();
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiVolumeCollection) dataCimi, (List<Object>) dataService);
    }
