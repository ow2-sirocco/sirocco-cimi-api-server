 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiSystemSystemCollection}</li>
 * <li>Service model: {@link List<SystemSystem>}</li>
 * </ul>
 * </p>
 */
public class SystemSystemCollectionConverter extends CollectionConverterAbstract {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiSystemSystemCollection cimi = new CimiSystemSystemCollection();
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (List<Object>) dataService, (CimiSystemSystemCollection) dataCimi);
    }
    ...
    public Object toService(final CimiContext context, final Object dataCimi) {
        List<SystemSystem> service = new ArrayList<SystemSystem>();
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiSystemSystemCollection) dataCimi, (List<Object>) dataService);
    }
