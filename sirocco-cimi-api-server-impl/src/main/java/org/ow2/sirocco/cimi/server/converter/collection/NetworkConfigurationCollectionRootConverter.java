 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiNetworkConfigurationCollectionRoot}</li>
 * <li>Service model: {@link List<NetworkConfiguration>}</li>
 * </ul>
 * </p>
 */
public class NetworkConfigurationCollectionRootConverter extends NetworkConfigurationCollectionConverter {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiNetworkConfigurationCollectionRoot cimi = new CimiNetworkConfigurationCollectionRoot();
