 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiCredentialCollectionRoot}</li>
 * <li>Service model: {@link List<Credential>}</li>
 * </ul>
 * </p>
 */
public class CredentialCollectionRootConverter extends CredentialCollectionConverter {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiCredentialCollectionRoot cimi = new CimiCredentialCollectionRoot();
