 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiMachineVolumeCollection}</li>
 * <li>Service model: {@link List<MachineVolume>}</li>
 * </ul>
 * </p>
 */
public class MachineVolumeCollectionConverter extends CollectionConverterAbstract {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiMachineVolumeCollection cimi = new CimiMachineVolumeCollection();
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (List<Object>) dataService, (CimiMachineVolumeCollection) dataCimi);
    }
    ...
    public Object toService(final CimiContext context, final Object dataCimi) {
        List<MachineVolume> service = new ArrayList<MachineVolume>();
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiMachineVolumeCollection) dataCimi, (List<Object>) dataService);
    }
