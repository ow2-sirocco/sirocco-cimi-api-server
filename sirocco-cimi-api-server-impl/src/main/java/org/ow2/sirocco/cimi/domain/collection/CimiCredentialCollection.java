...
public class CimiCredentialCollection extends CimiCollectionAbstract<CimiCredential> {
    ...
    public CimiCredential[] getArray() {
    ...
    @Override
    @JsonProperty(value = "credentials")
    public void setArray(final CimiCredential[] items) {
     ...
     */
    @Override
    public CimiArray<CimiCredential> newCollection() {
    ...
    @XmlTransient
    @JsonIgnore
    public Class<CimiCredential> getItemClass() {
        return CimiCredential.class;
    }

    /**
     * Concrete class of the collection.
     */
    public class CimiCredentialsArray extends CimiArrayAbstract<CimiCredential> {

        /** Serial number */
        private static final long serialVersionUID = 1L;

        @Override
        public CimiCredential[] newEmptyArraySized() {
            return new CimiCredential[this.size()];
        }
    }
}
