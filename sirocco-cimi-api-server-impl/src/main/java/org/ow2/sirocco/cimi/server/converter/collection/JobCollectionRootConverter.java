 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiJobCollectionRoot}</li>
 * <li>Service model: {@link List<Job>}</li>
 * </ul>
 * </p>
 */
public class JobCollectionRootConverter extends JobCollectionConverter {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiJobCollectionRoot cimi = new CimiJobCollectionRoot();
