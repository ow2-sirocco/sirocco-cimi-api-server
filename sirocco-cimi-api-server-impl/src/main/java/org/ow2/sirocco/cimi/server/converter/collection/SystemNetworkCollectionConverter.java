 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiSystemNetworkCollection}</li>
 * <li>Service model: {@link List<SystemNetwork>}</li>
 * </ul>
 * </p>
 */
public class SystemNetworkCollectionConverter extends CollectionConverterAbstract {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiSystemNetworkCollection cimi = new CimiSystemNetworkCollection();
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (List<Object>) dataService, (CimiSystemNetworkCollection) dataCimi);
    }
    ...
    public Object toService(final CimiContext context, final Object dataCimi) {
        List<SystemNetwork> service = new ArrayList<SystemNetwork>();
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiSystemNetworkCollection) dataCimi, (List<Object>) dataService);
    }
