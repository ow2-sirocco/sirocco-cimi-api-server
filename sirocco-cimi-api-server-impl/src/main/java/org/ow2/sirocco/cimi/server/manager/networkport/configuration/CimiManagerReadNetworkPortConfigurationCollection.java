...
/**
 * Manage READ request of NetworkPorts Configurations collection.
 */
@org.ow2.sirocco.cimi.server.manager.Manager("CimiManagerReadNetworkPortConfigurationCollection")
public class CimiManagerReadNetworkPortConfigurationCollection extends CimiManagerReadAbstract {
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        ...
        if (false == context.hasParamsForReadingCollection()) {
            out = this.manager.getNetworkPortConfigurations();
        } else {
            QueryResult<?> results = this.manager.getNetworkPortConfigurations(context.valueOfFirst(), context.valueOfLast(),
    ...
    protected void convertToResponse(final CimiContext context, final Object dataService) throws Exception {
        CimiNetworkPortConfigurationCollectionRoot cimi = (CimiNetworkPortConfigurationCollectionRoot) context.convertToCimi(
            dataService, CimiNetworkPortConfigurationCollectionRoot.class);
