 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiVolumeTemplateCollection}</li>
 * <li>Service model: {@link List<VolumeTemplate>}</li>
 * </ul>
 * </p>
 */
public class VolumeTemplateCollectionConverter extends CollectionConverterAbstract {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiVolumeTemplateCollection cimi = new CimiVolumeTemplateCollection();
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (List<Object>) dataService, (CimiVolumeTemplateCollection) dataCimi);
    }
    ...
    public Object toService(final CimiContext context, final Object dataCimi) {
        List<VolumeTemplate> service = new ArrayList<VolumeTemplate>();
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiVolumeTemplateCollection) dataCimi, (List<Object>) dataService);
    }
