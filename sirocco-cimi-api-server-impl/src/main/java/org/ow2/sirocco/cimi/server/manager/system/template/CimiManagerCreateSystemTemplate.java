...
/**
 * Manage CREATE request of SystemTemplate.
 */
@org.ow2.sirocco.cimi.server.manager.Manager("CimiManagerCreateSystemTemplate")
public class CimiManagerCreateSystemTemplate extends CimiManagerCreateAbstract {
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        return this.manager.createSystemTemplate((SystemTemplate) dataService);
    }
    ...
    protected void convertToResponse(final CimiContext context, final Object dataService) throws Exception {
        CimiSystemTemplate cimi = (CimiSystemTemplate) context.convertToCimi(dataService, CimiSystemTemplate.class);
