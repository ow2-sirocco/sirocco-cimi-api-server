...
public class CimiNetworkCollection extends CimiCollectionAbstract<CimiNetwork> {
    ...
    @Override
    @JsonProperty(value = "networks")
    public void setArray(final CimiNetwork[] items) {
    ...
    public ExchangeType getExchangeType() {
        return ExchangeType.NetworkCollection;
    }
     ...
     */
    @Override
    public CimiArray<CimiNetwork> newCollection() {
        return new CimiNetworkArray();
    }
    ...
    @XmlTransient
    @JsonIgnore
    public Class<CimiNetwork> getItemClass() {
        return CimiNetwork.class;
    }

    /**
     * Concrete class of the collection.
     */
    public class CimiNetworkArray extends CimiArrayAbstract<CimiNetwork> {
