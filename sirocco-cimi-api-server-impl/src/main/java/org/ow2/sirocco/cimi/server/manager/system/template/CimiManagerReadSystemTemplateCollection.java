...
public class CimiManagerReadSystemTemplateCollection extends CimiManagerReadAbstract {
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        ...
        if (false == context.hasParamsForReadingCollection()) {
            ...
            QueryResult<?> results = this.manager.getSystemTemplates(context.valueOfFirst(), context.valueOfLast(),
    ...
    protected void convertToResponse(final CimiContext context, final Object dataService) throws Exception {
        CimiSystemTemplateCollectionRoot cimi = (CimiSystemTemplateCollectionRoot) context.convertToCimi(dataService,
            CimiSystemTemplateCollectionRoot.class);
