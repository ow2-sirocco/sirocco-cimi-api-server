...
/**
 * Manage UPDATE request of MachineVolume.
 */
@org.ow2.sirocco.cimi.server.manager.Manager("CimiManagerUpdateMachineVolume")
public class CimiManagerUpdateMachineVolume extends CimiManagerUpdateAbstract {
