 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiForwardingGroupNetworkCollectionRoot}</li>
 * <li>Service model: {@link List<ForwardingGroupNetwork>}</li>
 * </ul>
 * </p>
 */
public class ForwardingGroupNetworkCollectionRootConverter extends ForwardingGroupNetworkCollectionConverter {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiForwardingGroupNetworkCollectionRoot cimi = new CimiForwardingGroupNetworkCollectionRoot();
