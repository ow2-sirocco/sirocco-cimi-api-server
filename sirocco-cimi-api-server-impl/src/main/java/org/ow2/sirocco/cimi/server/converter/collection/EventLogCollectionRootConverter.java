 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiEventLogCollectionRoot}</li>
 * <li>Service model: {@link List<EventLog>}</li>
 * </ul>
 * </p>
 */
public class EventLogCollectionRootConverter extends EventLogCollectionConverter {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiEventLogCollectionRoot cimi = new CimiEventLogCollectionRoot();
