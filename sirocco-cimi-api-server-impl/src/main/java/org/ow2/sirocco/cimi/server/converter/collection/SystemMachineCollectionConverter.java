 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiSystemMachineCollection}</li>
 * <li>Service model: {@link List<SystemMachine>}</li>
 * </ul>
 * </p>
 */
public class SystemMachineCollectionConverter extends CollectionConverterAbstract {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiSystemMachineCollection cimi = new CimiSystemMachineCollection();
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (List<Object>) dataService, (CimiSystemMachineCollection) dataCimi);
    }
    ...
    public Object toService(final CimiContext context, final Object dataCimi) {
        List<SystemMachine> service = new ArrayList<SystemMachine>();
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiSystemMachineCollection) dataCimi, (List<Object>) dataService);
    }
