 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiAddressCollection}</li>
 * <li>Service model: {@link List<Address>}</li>
 * </ul>
 * </p>
 */
public class AddressCollectionConverter extends CollectionConverterAbstract {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiAddressCollection cimi = new CimiAddressCollection();
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (List<Object>) dataService, (CimiAddressCollection) dataCimi);
    }
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiAddressCollection) dataCimi, (List<Object>) dataService);
    }
