...
/**
 * Manage CREATE request of Volume Configuration.
 */
@org.ow2.sirocco.cimi.server.manager.Manager("CimiManagerCreateVolumeConfiguration")
public class CimiManagerCreateVolumeConfiguration extends CimiManagerCreateAbstract {
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        return this.manager.createVolumeConfiguration((VolumeConfiguration) dataService);
    }
    ...
    protected void beforeConvertToDataService(final CimiContext context) throws Exception {
        this.mergeReference.merge(context, (CimiVolumeConfiguration) context.getRequest().getCimiData());
    }
}
