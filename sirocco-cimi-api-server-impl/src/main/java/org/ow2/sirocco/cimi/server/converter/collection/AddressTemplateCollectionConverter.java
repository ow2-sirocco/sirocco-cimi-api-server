 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiAddressTemplateCollection}</li>
 * <li>Service model: {@link List<AddressTemplate>}</li>
 * </ul>
 * </p>
 */
public class AddressTemplateCollectionConverter extends CollectionConverterAbstract {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiAddressTemplateCollection cimi = new CimiAddressTemplateCollection();
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (List<Object>) dataService, (CimiAddressTemplateCollection) dataCimi);
    }
    ...
    public Object toService(final CimiContext context, final Object dataCimi) {
        List<AddressTemplate> service = new ArrayList<AddressTemplate>();
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiAddressTemplateCollection) dataCimi, (List<Object>) dataService);
    }
