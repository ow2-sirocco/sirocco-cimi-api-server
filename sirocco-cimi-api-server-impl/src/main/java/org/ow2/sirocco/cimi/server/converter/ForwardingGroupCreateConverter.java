 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiForwardingGroupCreate}</li>
 * <li>Service model: {@link ForwardingGroupCreate}</li>
 * </ul>
 * </p>
 */
public class ForwardingGroupCreateConverter implements CimiConverter {
    ...
    public Object toService(final CimiContext context, final Object dataCimi) {
        ForwardingGroupCreate service = new ForwardingGroupCreate();
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiForwardingGroupCreate) dataCimi, (ForwardingGroupCreate) dataService);
    }
     ...
     */
    protected void fill(final CimiForwardingGroupCreate dataCimi, final ForwardingGroupCreate dataService) {
     ...
     * @param dataService Destination Service object
     */
    protected void doCopyToService(final CimiContext context, final CimiForwardingGroupCreate dataCimi,
        final ForwardingGroupCreate dataService) {
        this.fill(dataCimi, dataService);
        dataService.setForwardingGroupTemplate((ForwardingGroupTemplate) context.convertNextService(dataCimi
            .getForwardingGroupTemplate()));
    }
}
