...
/**
 * Manage CREATE request of Address.
 */
@org.ow2.sirocco.cimi.server.manager.Manager("CimiManagerCreateAddress")
public class CimiManagerCreateAddress extends CimiManagerCreateAbstract {
    @Inject
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        return this.manager.createAddress((AddressCreate) dataService);
    }
    ...
    protected void beforeConvertToDataService(final CimiContext context) throws Exception {
        this.mergeReference.merge(context, (CimiAddressCreate) context.getRequest().getCimiData());
    }
