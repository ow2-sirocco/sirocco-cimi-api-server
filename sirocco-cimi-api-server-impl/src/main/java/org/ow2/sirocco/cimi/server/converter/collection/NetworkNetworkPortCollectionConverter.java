 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiNetworkNetworkPortCollection}</li>
 * <li>Service model: {@link List<NetworkPort>}</li>
 * </ul>
 * </p>
 */
public class NetworkNetworkPortCollectionConverter extends CollectionConverterAbstract {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiNetworkNetworkPortCollection cimi = new CimiNetworkNetworkPortCollection();
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (List<Object>) dataService, (CimiNetworkNetworkPortCollection) dataCimi);
    }
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiNetworkNetworkPortCollection) dataCimi, (List<Object>) dataService);
    }
