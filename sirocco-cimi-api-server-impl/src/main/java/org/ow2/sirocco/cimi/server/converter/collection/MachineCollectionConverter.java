 ...
 * <li>Service model: {@link List<Machine>}</li>
 * </ul>
 * </p>
 */
public class MachineCollectionConverter extends CollectionConverterAbstract {
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (List<Object>) dataService, (CimiMachineCollection) dataCimi);
    }
    ...
    public Object toService(final CimiContext context, final Object dataCimi) {
        List<Machine> service = new ArrayList<Machine>();
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiMachineCollection) dataCimi, (List<Object>) dataService);
    }
