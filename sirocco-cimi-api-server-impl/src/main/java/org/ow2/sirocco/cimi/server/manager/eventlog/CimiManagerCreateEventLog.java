...
/**
 * Manage CREATE request of EventLog.
 */
@org.ow2.sirocco.cimi.server.manager.Manager("CimiManagerCreateEventLog")
public class CimiManagerCreateEventLog extends CimiManagerCreateAbstract {
    @Inject
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        return this.manager.createEventLog((EventLogCreate) dataService);
    }
    ...
    protected void beforeConvertToDataService(final CimiContext context) throws Exception {
        this.mergeReference.merge(context, (CimiEventLogCreate) context.getRequest().getCimiData());
    }
