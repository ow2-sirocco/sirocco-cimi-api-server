...
/**
 * Manage READ request of NetworkPortTemplates collection.
 */
@org.ow2.sirocco.cimi.server.manager.Manager("CimiManagerReadNetworkPortTemplateCollection")
public class CimiManagerReadNetworkPortTemplateCollection extends CimiManagerReadAbstract {
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        ...
        if (false == context.hasParamsForReadingCollection()) {
            out = this.manager.getNetworkPortTemplates();
        } else {
            QueryResult<?> results = this.manager.getNetworkPortTemplates(context.valueOfFirst(), context.valueOfLast(),
    ...
    protected void convertToResponse(final CimiContext context, final Object dataService) throws Exception {
        CimiNetworkPortTemplateCollectionRoot cimi = (CimiNetworkPortTemplateCollectionRoot) context.convertToCimi(dataService,
            CimiNetworkPortTemplateCollectionRoot.class);
