...
public abstract class CimiObjectCommonAbstract extends CimiCommon implements CimiObjectCommon {
     ...
     * {@inheritDoc}
     * 
     * @see org.ow2.sirocco.cimi.server.domain.CimiResource#getId()
     */
    @Override
    public String getId() {
     ...
     * {@inheritDoc}
     * 
     * @see org.ow2.sirocco.cimi.server.domain.CimiResource#setId(java.lang.String)
     */
    @Override
     ...
     * {@inheritDoc}
     * 
     * @see org.ow2.sirocco.cimi.server.domain.CimiObjectCommon#getCreated()
     */
    @Override
     ...
     * {@inheritDoc}
     * 
     * @see org.ow2.sirocco.cimi.server.domain.CimiObjectCommon#setCreated(java
     *      .util.Date)
     */
    @Override
     ...
     * {@inheritDoc}
     * 
     * @see org.ow2.sirocco.cimi.server.domain.CimiObjectCommon#getUpdated()
     */
    @Override
    @XmlJavaTypeAdapter(CimiDateAdapter.class)
     ...
     * {@inheritDoc}
     * 
     * @see org.ow2.sirocco.cimi.server.domain.CimiObjectCommon#setUpdated(java
     *      .util.Date)
     */
    @Override
     ...
     * {@inheritDoc}
     * 
     * @see org.ow2.sirocco.cimi.server.domain.CimiResource#getResourceURI()
     */
    @Override
    @XmlTransient
     ...
     * {@inheritDoc}
     * 
     * @see org.ow2.sirocco.cimi.server.domain.CimiResource#setResourceURI(java
     *      .lang.String)
     */
    @Override
     ...
     * {@inheritDoc}
     * 
     * @see org.ow2.sirocco.cimi.server.domain.CimiResource#getHref()
     */
    @Override
    @XmlAttribute
     ...
     * {@inheritDoc}
     * 
     * @see org.ow2.sirocco.cimi.server.domain.CimiResource#setHref(java.lang.
     *      String)
     */
    @Override
     ...
     * {@inheritDoc}
     * 
     * @see org.ow2.sirocco.cimi.server.domain.CimiResource#hasReference()
     */
    @Override
     ...
     * {@inheritDoc}
     * 
     * @see org.ow2.sirocco.cimi.server.domain.CimiResource#hasValues()
     */
    @Override
     ...
     * {@inheritDoc}
     * 
     * @see org.ow2.sirocco.cimi.server.domain.CimiResource#getOperations()
     */
    @Override
     ...
     * {@inheritDoc}
     * 
     * @see org.ow2.sirocco.cimi.server.domain.CimiResource#setOperations(org.ow2.sirocco.cimi.server.domain.CimiOperation[])
     */
    @Override
     ...
     * {@inheritDoc}
     * 
     * @see org.ow2.sirocco.cimi.server.domain.CimiResource#getListOperations()
     */
    @Override
    @XmlTransient
    @JsonIgnore
     ...
     * {@inheritDoc}
     * 
     * @see org.ow2.sirocco.cimi.server.domain.CimiResource#setListOperations(java.util.List)
     */
    @Override
     ...
     * {@inheritDoc}
     * 
     * @see org.ow2.sirocco.cimi.server.domain.CimiResource#add(org.ow2.sirocco.cimi.server.domain.CimiOperation)
     */
    @Override
