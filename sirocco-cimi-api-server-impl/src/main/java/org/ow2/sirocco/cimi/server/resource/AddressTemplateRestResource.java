...
/**
 * Address Template REST resource.
 * <p>
 * Operations supports :
 * <ul>
 * <li>Create a address template</li>
 * <li>Delete a address template</li>
 * <li>Read a address template</li>
 * <li>Read a collection of addresss templates</li>
 * <li>Update a address template</li>
 * </ul>
 * </p>
 */
...
public class AddressTemplateRestResource extends RestResourceAbstract {
    ...
    @Inject
    @Manager("CimiManagerReadAddressTemplate")
    private CimiManager cimiManagerReadAddressTemplate;

    @Inject
    @Manager("CimiManagerReadAddressTemplateCollection")
    private CimiManager cimiManagerReadAddressTemplateCollection;

    @Inject
    @Manager("CimiManagerDeleteAddressTemplate")
    private CimiManager cimiManagerDeleteAddressTemplate;

    @Inject
    @Manager("CimiManagerUpdateAddressTemplate")
    private CimiManager cimiManagerUpdateAddressTemplate;

    @Inject
    @Manager("CimiManagerCreateAddressTemplate")
    private CimiManager cimiManagerCreateAddressTemplate;

    /**
     * Get a address template.
     * 
     * @param id The ID of address template to get
    ...
    public Response read(@PathParam("id") final String id) {
        ...
        this.cimiManagerReadAddressTemplate.execute(context);
        return ResponseHelper.buildResponse(context.getResponse());
    }

    /**
     * Get a collection of addresss templates.
     * 
     * @return The REST response
     */
    @GET
    ...
    public Response read() {
        ...
        this.cimiManagerReadAddressTemplateCollection.execute(context);
        return ResponseHelper.buildResponse(context.getResponse());
    }

    /**
     * Update a address template.
     * 
     * @param id The ID of address template to update
     * @return The REST response
     */
    @PUT
    @Consumes({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
    @Path("/{id}")
    public Response update(@PathParam("id") final String id, final CimiAddressTemplate cimiData) {
        CimiContext context = ContextHelper.buildContext(this.getJaxRsRequestInfos(), id, cimiData);
        this.cimiManagerUpdateAddressTemplate.execute(context);
        return ResponseHelper.buildResponse(context.getResponse());
    }
    ...
    @POST
    @Consumes({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
    public Response create(final CimiAddressTemplate cimiData) {
        CimiContext context = ContextHelper.buildContext(this.getJaxRsRequestInfos(), cimiData);
        this.cimiManagerCreateAddressTemplate.execute(context);
        return ResponseHelper.buildResponse(context.getResponse());
    }

    /**
     * Delete a address template.
     * 
     * @param id The ID of address template to delete
     * @return The REST response
     */
    @DELETE
    @Path("/{id}")
    public Response delete(@PathParam("id") final String id) {
        CimiContext context = ContextHelper.buildContext(this.getJaxRsRequestInfos(), id);
        this.cimiManagerDeleteAddressTemplate.execute(context);
        return ResponseHelper.buildResponse(context.getResponse());
    }
