 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiNetworkPortConfigurationCollectionRoot}</li>
...
public class NetworkPortConfigurationCollectionRootConverter extends NetworkPortConfigurationCollectionConverter {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiNetworkPortConfigurationCollectionRoot cimi = new CimiNetworkPortConfigurationCollectionRoot();
