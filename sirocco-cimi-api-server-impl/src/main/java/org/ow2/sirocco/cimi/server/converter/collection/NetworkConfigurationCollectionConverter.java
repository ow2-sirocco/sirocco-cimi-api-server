 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiNetworkConfigurationCollection}</li>
 * <li>Service model: {@link List<NetworkConfiguration>}</li>
 * </ul>
 * </p>
 */
public class NetworkConfigurationCollectionConverter extends CollectionConverterAbstract {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiNetworkConfigurationCollection cimi = new CimiNetworkConfigurationCollection();
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (List<Object>) dataService, (CimiNetworkConfigurationCollection) dataCimi);
    }
    ...
    public Object toService(final CimiContext context, final Object dataCimi) {
        List<NetworkConfiguration> service = new ArrayList<NetworkConfiguration>();
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiNetworkConfigurationCollection) dataCimi, (List<Object>) dataService);
    }
