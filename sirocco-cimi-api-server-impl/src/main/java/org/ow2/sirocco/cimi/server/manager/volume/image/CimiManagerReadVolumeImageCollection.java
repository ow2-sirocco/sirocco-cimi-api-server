...
/**
 * Manage READ request of Volumes Images collection.
 */
@org.ow2.sirocco.cimi.server.manager.Manager("CimiManagerReadVolumeImageCollection")
public class CimiManagerReadVolumeImageCollection extends CimiManagerReadAbstract {
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        ...
        if (false == context.hasParamsForReadingCollection()) {
            out = this.manager.getVolumeImages();
        } else {
            QueryResult<?> results = this.manager.getVolumeImages(context.valueOfFirst(), context.valueOfLast(),
    ...
    protected void convertToResponse(final CimiContext context, final Object dataService) throws Exception {
        CimiVolumeImageCollectionRoot cimi = (CimiVolumeImageCollectionRoot) context.convertToCimi(dataService,
            CimiVolumeImageCollectionRoot.class);
