...
/**
 * Manage DELETE request of EventLogEvent.
 */
@org.ow2.sirocco.cimi.server.manager.Manager("CimiManagerDeleteEventLogEvent")
public class CimiManagerDeleteEventLogEvent extends CimiManagerDeleteAbstract {
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        this.manager.removeEventFromEventLog(context.getRequest().getIdParent(), context.getRequest().getId());
        return null;
    }
}
