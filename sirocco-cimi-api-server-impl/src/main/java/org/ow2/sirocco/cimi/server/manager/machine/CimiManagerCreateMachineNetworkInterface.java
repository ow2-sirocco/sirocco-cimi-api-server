...
/**
 * Manage CREATE request of MachineNetworkInterface.
 */
@org.ow2.sirocco.cimi.server.manager.Manager("CimiManagerCreateMachineNetworkInterface")
public class CimiManagerCreateMachineNetworkInterface extends CimiManagerCreateAbstract {
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        return this.manager.addNetworkInterfaceToMachine(context.getRequest().getIdParent(),
            (MachineNetworkInterface) dataService);
    }
    ...
    protected void beforeConvertToDataService(final CimiContext context) throws Exception {
        this.mergeReference.merge(context, (CimiMachineNetworkInterface) context.getRequest().getCimiData());
    }
