 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiCredentialTemplateCollectionRoot}</li>
 * <li>Service model: {@link List<CredentialTemplate>}</li>
 * </ul>
 * </p>
 */
public class CredentialTemplateCollectionRootConverter extends CredentialTemplateCollectionConverter {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiCredentialTemplateCollectionRoot cimi = new CimiCredentialTemplateCollectionRoot();
