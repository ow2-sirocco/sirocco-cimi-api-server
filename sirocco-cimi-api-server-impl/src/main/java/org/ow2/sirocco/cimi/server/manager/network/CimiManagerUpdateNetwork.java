...
/**
 * Manage UPDATE request of Network.
 */
@org.ow2.sirocco.cimi.server.manager.Manager("CimiManagerUpdateNetwork")
public class CimiManagerUpdateNetwork extends CimiManagerUpdateAbstract {
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        ...
        if (false == context.hasParamSelect()) {
            out = this.manager.updateNetwork((Network) dataService);
        } else {
            out = this.manager.updateNetworkAttributes(context.getRequest().getId(),
