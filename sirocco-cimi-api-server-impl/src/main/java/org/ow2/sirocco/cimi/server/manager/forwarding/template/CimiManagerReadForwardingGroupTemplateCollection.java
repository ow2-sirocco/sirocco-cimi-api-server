...
/**
 * Manage READ request of ForwardingGroupTemplates collection.
 */
@org.ow2.sirocco.cimi.server.manager.Manager("CimiManagerReadForwardingGroupTemplateCollection")
public class CimiManagerReadForwardingGroupTemplateCollection extends CimiManagerReadAbstract {
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        ...
        if (false == context.hasParamsForReadingCollection()) {
            out = this.manager.getForwardingGroupTemplates();
        } else {
            QueryResult<?> results = this.manager.getForwardingGroupTemplates(context.valueOfFirst(), context.valueOfLast(),
    ...
    protected void convertToResponse(final CimiContext context, final Object dataService) throws Exception {
        CimiForwardingGroupTemplateCollectionRoot cimi = (CimiForwardingGroupTemplateCollectionRoot) context.convertToCimi(
            dataService, CimiForwardingGroupTemplateCollectionRoot.class);
