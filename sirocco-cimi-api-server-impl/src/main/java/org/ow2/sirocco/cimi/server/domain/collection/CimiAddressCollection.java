...
public class CimiAddressCollection extends CimiCollectionAbstract<CimiAddress> {
    ...
    @Override
    @JsonProperty(value = "addresses")
    public void setArray(final CimiAddress[] items) {
     ...
     */
    @Override
    public CimiArray<CimiAddress> newCollection() {
        return new CimiAddressArray();
    }
    ...
    public ExchangeType getExchangeType() {
        return ExchangeType.AddressCollection;
    }
    ...
    @XmlTransient
    @JsonIgnore
    public Class<CimiAddress> getItemClass() {
        return CimiAddress.class;
    }
