 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiEventTypeAccess}</li>
 * <li>Service model: {@link AccessEventType}</li>
 * </ul>
 * </p>
 */
public class EventTypeAccessConverter extends EventTypeConverter {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiEventTypeAccess cimi = new CimiEventTypeAccess();
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (AccessEventType) dataService, (CimiEventTypeAccess) dataCimi);
    }
     ...
     */
    protected void doCopyToCimi(final CimiContext context, final AccessEventType dataService, final CimiEventTypeAccess dataCimi) {
        this.fill(context, dataService, dataCimi);
        dataCimi.setInitiator(dataService.getInitiator());
        dataCimi.setOperation(dataService.getOperation());
    }
}
