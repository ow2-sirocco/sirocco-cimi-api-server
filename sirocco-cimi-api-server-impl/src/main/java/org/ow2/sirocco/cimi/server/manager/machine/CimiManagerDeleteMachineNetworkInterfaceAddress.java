...
/**
 * Manage DELETE request of MachineNetworkInterfaceAddress.
 */
@org.ow2.sirocco.cimi.server.manager.Manager("CimiManagerDeleteMachineNetworkInterfaceAddress")
public class CimiManagerDeleteMachineNetworkInterfaceAddress extends CimiManagerDeleteAbstract {
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        return this.manager.removeAddressFromMachineNetworkInterface(
