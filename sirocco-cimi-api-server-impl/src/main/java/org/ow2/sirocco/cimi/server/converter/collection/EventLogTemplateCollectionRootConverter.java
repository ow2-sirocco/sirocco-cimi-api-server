 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiEventLogTemplateCollectionRoot}</li>
 * <li>Service model: {@link List<EventLogTemplate>}</li>
 * </ul>
 * </p>
 */
public class EventLogTemplateCollectionRootConverter extends EventLogTemplateCollectionConverter {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiEventLogTemplateCollectionRoot cimi = new CimiEventLogTemplateCollectionRoot();
