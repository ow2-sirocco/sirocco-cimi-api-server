 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiSystemCollection}</li>
 * <li>Service model: {@link List<System>}</li>
 * </ul>
 * </p>
 */
public class SystemCollectionConverter extends CollectionConverterAbstract {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiSystemCollection cimi = new CimiSystemCollection();
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (List<Object>) dataService, (CimiSystemCollection) dataCimi);
    }
    ...
    public Object toService(final CimiContext context, final Object dataCimi) {
        List<System> service = new ArrayList<System>();
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiSystemCollection) dataCimi, (List<Object>) dataService);
    }
