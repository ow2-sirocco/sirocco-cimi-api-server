 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiVolumeConfigurationCollection}</li>
 * <li>Service model: {@link List<VolumeConfiguration>}</li>
 * </ul>
 * </p>
 */
public class VolumeConfigurationCollectionConverter extends CollectionConverterAbstract {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiVolumeConfigurationCollection cimi = new CimiVolumeConfigurationCollection();
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (List<Object>) dataService, (CimiVolumeConfigurationCollection) dataCimi);
    }
    ...
    public Object toService(final CimiContext context, final Object dataCimi) {
        List<VolumeConfiguration> service = new ArrayList<VolumeConfiguration>();
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiVolumeConfigurationCollection) dataCimi, (List<Object>) dataService);
    }
