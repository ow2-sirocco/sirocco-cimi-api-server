...
/**
 * Manage UPDATE request of EventLogTemplate.
 */
@org.ow2.sirocco.cimi.server.manager.Manager("CimiManagerUpdateEventLogTemplate")
public class CimiManagerUpdateEventLogTemplate extends CimiManagerUpdateAbstract {
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        if (false == context.hasParamSelect()) {
            this.manager.updateEventLogTemplate((EventLogTemplate) dataService);
        } else {
            this.manager.updateEventLogTemplateAttributes(context.getRequest().getId(),
