 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiSystemMachineCollectionRoot}</li>
 * <li>Service model: {@link List<SystemMachine>}</li>
 * </ul>
 * </p>
 */
public class SystemMachineCollectionRootConverter extends SystemMachineCollectionConverter {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiSystemMachineCollectionRoot cimi = new CimiSystemMachineCollectionRoot();
