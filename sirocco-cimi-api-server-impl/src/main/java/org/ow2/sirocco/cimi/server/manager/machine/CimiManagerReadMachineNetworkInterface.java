 ...
 */
@org.ow2.sirocco.cimi.server.manager.Manager("CimiManagerReadMachineNetworkInterface")
public class CimiManagerReadMachineNetworkInterface extends CimiManagerReadAbstract {
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        MachineNetworkInterface out = null;
        out = this.manager.getNetworkInterfaceFromMachine(context.getRequest().getIdParent(), context.getRequest().getId());
        return out;
    }
    ...
    protected void convertToResponse(final CimiContext context, final Object dataService) throws Exception {
        CimiMachineNetworkInterface cimi = (CimiMachineNetworkInterface) context.convertToCimi(dataService,
