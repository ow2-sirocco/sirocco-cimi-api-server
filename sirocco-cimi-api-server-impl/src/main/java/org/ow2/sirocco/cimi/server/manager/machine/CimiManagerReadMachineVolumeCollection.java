 ...
 */
@org.ow2.sirocco.cimi.server.manager.Manager("CimiManagerReadMachineVolumeCollection")
public class CimiManagerReadMachineVolumeCollection extends CimiManagerReadAbstract {
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        ...
        if (false == context.hasParamsForReadingCollection()) {
            result = this.manager.getMachineVolumes(context.getRequest().getIdParent());
        } else {
            result = this.manager.getMachineVolumes(
    ...
    protected void convertToResponse(final CimiContext context, final Object dataService) throws Exception {
        CimiMachineVolumeCollectionRoot cimi = (CimiMachineVolumeCollectionRoot) context.convertToCimi(dataService,
            CimiMachineVolumeCollectionRoot.class);
