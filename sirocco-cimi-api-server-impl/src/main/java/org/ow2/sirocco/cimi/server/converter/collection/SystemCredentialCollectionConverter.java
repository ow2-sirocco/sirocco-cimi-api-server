 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiSystemCredentialCollection}</li>
 * <li>Service model: {@link List<SystemCredential>}</li>
 * </ul>
 * </p>
 */
public class SystemCredentialCollectionConverter extends CollectionConverterAbstract {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiSystemCredentialCollection cimi = new CimiSystemCredentialCollection();
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (List<Object>) dataService, (CimiSystemCredentialCollection) dataCimi);
    }
    ...
    public Object toService(final CimiContext context, final Object dataCimi) {
        List<SystemCredentials> service = new ArrayList<SystemCredentials>();
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiSystemCredentialCollection) dataCimi, (List<Object>) dataService);
    }
