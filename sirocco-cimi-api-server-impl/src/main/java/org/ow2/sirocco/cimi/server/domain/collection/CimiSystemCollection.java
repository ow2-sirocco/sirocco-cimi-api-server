...
public class CimiSystemCollection extends CimiCollectionAbstract<CimiSystem> {
    ...
    @Override
    @JsonProperty(value = "systems")
    public void setArray(final CimiSystem[] items) {
     ...
     */
    @Override
    public CimiArray<CimiSystem> newCollection() {
        return new CimiSystemArray();
    }
    ...
    public ExchangeType getExchangeType() {
        return ExchangeType.SystemCollection;
    }
    ...
    @XmlTransient
    @JsonIgnore
    public Class<CimiSystem> getItemClass() {
        return CimiSystem.class;
    }

    /**
     * Concrete class of the collection.
     */
    public class CimiSystemArray extends CimiArrayAbstract<CimiSystem> {

        /** Serial number */
        private static final long serialVersionUID = 1L;

        @Override
        public CimiSystem[] newEmptyArraySized() {
            return new CimiSystem[this.size()];
        }
    }
}
