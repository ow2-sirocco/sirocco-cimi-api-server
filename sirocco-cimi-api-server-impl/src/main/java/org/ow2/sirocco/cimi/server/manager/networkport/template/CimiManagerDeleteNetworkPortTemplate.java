...
/**
 * Manage DELETE request of NetworkPortTemplate.
 */
@org.ow2.sirocco.cimi.server.manager.Manager("CimiManagerDeleteNetworkPortTemplate")
public class CimiManagerDeleteNetworkPortTemplate extends CimiManagerDeleteAbstract {
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        this.manager.deleteNetworkPortTemplate(context.getRequest().getId());
        return null;
    }
