 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiVolumeCollectionRoot}</li>
 * <li>Service model: {@link List<Volume>}</li>
 * </ul>
 * </p>
 */
public class VolumeCollectionRootConverter extends VolumeCollectionConverter {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiVolumeCollectionRoot cimi = new CimiVolumeCollectionRoot();
