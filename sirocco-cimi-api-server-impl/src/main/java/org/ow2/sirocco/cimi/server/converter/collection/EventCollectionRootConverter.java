 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiEventCollectionRoot}</li>
 * <li>Service model: {@link List<Event>}</li>
 * </ul>
 * </p>
 */
public class EventCollectionRootConverter extends EventCollectionConverter {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiEventCollectionRoot cimi = new CimiEventCollectionRoot();
