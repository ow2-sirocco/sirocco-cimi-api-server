...
/**
 * Collection of SystemTemplate.
 */
@XmlRootElement
@XmlType(propOrder = {"id", "count", "array", "operations"})
@JsonSerialize(include = Inclusion.NON_NULL)
public class CimiSystemTemplateCollection extends CimiCollectionAbstract<CimiSystemTemplate> {
     ...
     */
    @Override
    @XmlElement(name = "SystemTemplate")
    @JsonProperty(value = "systemTemplates")
    public CimiSystemTemplate[] getArray() {
    ...
    @Override
    @JsonProperty(value = "systemTemplates")
    public void setArray(final CimiSystemTemplate[] items) {
     ...
     */
    @Override
    public CimiArray<CimiSystemTemplate> newCollection() {
        return new CimiSystemTemplateArray();
    }
    ...
    public ExchangeType getExchangeType() {
        return ExchangeType.SystemTemplateCollection;
    }
    ...
    @XmlTransient
    @JsonIgnore
    public Class<CimiSystemTemplate> getItemClass() {
        return CimiSystemTemplate.class;
    }

    /**
     * Concrete class of the collection.
     */
    public class CimiSystemTemplateArray extends CimiArrayAbstract<CimiSystemTemplate> {

        /** Serial number */
        private static final long serialVersionUID = 1L;

        @Override
        public CimiSystemTemplate[] newEmptyArraySized() {
            return new CimiSystemTemplate[this.size()];
        }
    }
}
