 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiSystemCredentialCollectionRoot}</li>
 * <li>Service model: {@link List<SystemCredential>}</li>
 * </ul>
 * </p>
 */
public class SystemCredentialCollectionRootConverter extends SystemCredentialCollectionConverter {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiSystemCredentialCollectionRoot cimi = new CimiSystemCredentialCollectionRoot();
