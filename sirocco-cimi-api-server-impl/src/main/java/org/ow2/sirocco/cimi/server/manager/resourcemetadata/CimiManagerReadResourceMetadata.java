...
/**
 * Manage READ request of ResourceMetadata.
 */
@org.ow2.sirocco.cimi.server.manager.Manager("CimiManagerReadResourceMetadata")
public class CimiManagerReadResourceMetadata extends CimiManagerReadAbstract {
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        CimiResourceMetadata out = null;
        if (false == context.hasParamSelect()) {
            out = this.manager.getResourceMetadataById(context.getRequest().getId());
        } else {
            out = this.manager.getResourceMetadataAttributes(context.getRequest().getId(), context.valuesOfSelect());
        }
        return out;
    }
    ...
    protected void convertToResponse(final CimiContext context, final Object dataService) throws Exception {
        CimiResourceMetadata cimi = (CimiResourceMetadata) context.convertToCimi(dataService, CimiResourceMetadata.class);
