 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiMachineDiskCollectionRoot}</li>
 * <li>Service model: {@link List<MachineDisk>}</li>
 * </ul>
 * </p>
 */
public class MachineDiskCollectionRootConverter extends MachineDiskCollectionConverter {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiMachineDiskCollectionRoot cimi = new CimiMachineDiskCollectionRoot();
