 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiEventCollection}</li>
 * <li>Service model: {@link List<Event>}</li>
 * </ul>
 * </p>
 */
public class EventCollectionConverter extends CollectionConverterAbstract {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiEventCollection cimi = new CimiEventCollection();
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (List<Object>) dataService, (CimiEventCollection) dataCimi);
    }
    ...
    public Object toService(final CimiContext context, final Object dataCimi) {
        List<Event> service = new ArrayList<Event>();
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiEventCollection) dataCimi, (List<Object>) dataService);
    }
