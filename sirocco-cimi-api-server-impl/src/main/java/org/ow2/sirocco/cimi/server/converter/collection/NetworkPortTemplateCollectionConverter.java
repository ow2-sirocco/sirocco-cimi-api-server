 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiNetworkPortTemplateCollection}</li>
 * <li>Service model: {@link List<NetworkPortTemplate>}</li>
 * </ul>
 * </p>
 */
public class NetworkPortTemplateCollectionConverter extends CollectionConverterAbstract {
    ...
    public Object toCimi(final CimiContext context, final Object dataService) {
        CimiNetworkPortTemplateCollection cimi = new CimiNetworkPortTemplateCollection();
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (List<Object>) dataService, (CimiNetworkPortTemplateCollection) dataCimi);
    }
    ...
    public Object toService(final CimiContext context, final Object dataCimi) {
        List<NetworkPortTemplate> service = new ArrayList<NetworkPortTemplate>();
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiNetworkPortTemplateCollection) dataCimi, (List<Object>) dataService);
    }
