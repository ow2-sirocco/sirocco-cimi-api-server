 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiAddressCreate}</li>
 * <li>Service model: {@link AddressCreate}</li>
 * </ul>
 * </p>
 */
public class AddressCreateConverter implements CimiConverter {
    ...
    public Object toService(final CimiContext context, final Object dataCimi) {
        AddressCreate service = new AddressCreate();
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiAddressCreate) dataCimi, (AddressCreate) dataService);
    }
     ...
     */
    protected void fill(final CimiAddressCreate dataCimi, final AddressCreate dataService) {
     ...
     * @param dataService Destination Service object
     */
    protected void doCopyToService(final CimiContext context, final CimiAddressCreate dataCimi, final AddressCreate dataService) {
        this.fill(dataCimi, dataService);
        dataService.setAddressTemplate((AddressTemplate) context.convertNextService(dataCimi.getAddressTemplate()));
