 ...
 * Class SystemAddress.
 */
@XmlRootElement(name = "SystemAddress")
...
public class CimiSystemAddress extends CimiObjectCommonAbstract {
    ...
    public ExchangeType getExchangeType() {
        return ExchangeType.SystemAddress;
    }
