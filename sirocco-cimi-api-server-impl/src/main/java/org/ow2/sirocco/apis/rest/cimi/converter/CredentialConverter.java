 ...
 * Converted classes:
 * <ul>
 * <li>CIMI model: {@link CimiCredential}</li>
 * <li>Service model: {@link Credentials}</li>
 * </ul>
 * </p>
 */
public class CredentialConverter extends ObjectCommonConverter {
    ...
    public void copyToCimi(final CimiContext context, final Object dataService, final Object dataCimi) {
        this.doCopyToCimi(context, (Credentials) dataService, (CimiCredential) dataCimi);
    }
    ...
    public void copyToService(final CimiContext context, final Object dataCimi, final Object dataService) {
        this.doCopyToService(context, (CimiCredential) dataCimi, (Credentials) dataService);
    }
